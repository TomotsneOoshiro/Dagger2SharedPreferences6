...
This is a sample application using SharedPreferences.  In this application, the SharedPreferences API are called in the Fragment. This uses Google Dagger2 and Espresso to test about SharedPreferences.
